...
metadata {
	definition(name: "Orvibo Moisture Sensor", namespace: "castlecole", author: "SmartThings", vid: "generic-leak", mnmn:"SmartThings", ocfDeviceType: "x.com.st.d.sensor.moisture") {
