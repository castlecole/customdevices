...
metadata {
	definition (name: "ZigBee RGB Bulb", namespace: "castlecole", author: "SmartThings", runLocally: true, minHubCoreVersion: '000.019.00012', executeCommandsLocally: true, ocfDeviceType: "oic.d.light") {
