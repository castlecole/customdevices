...
metadata {
	definition(name: "ZLL Dimmer Bulb", namespace: "castlecole", author: "SmartThings", ocfDeviceType: "oic.d.light", runLocally: true, minHubCoreVersion: '000.021.00001', executeCommandsLocally: true) {
		capability "Actuator"
