...
metadata {
	definition (name:"ZigBee Lock Without Codes", namespace:"castlecole", author:"SmartThings", vid:"generic-lock-2", mnmn:"SmartThings", runLocally:true, minHubCoreVersion:'000.022.00013', executeCommandsLocally:true) {
		capability "Actuator"
		capability "Lock"
		capability "Refresh"
		capability "Sensor"
