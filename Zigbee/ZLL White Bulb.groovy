...
metadata {
	definition(name: "ZLL White Color Temperature Bulb", namespace: "castlecole", author: "SmartThings", ocfDeviceType: "oic.d.light", runLocally: true, minHubCoreVersion: '000.021.00001', executeCommandsLocally: true) {
