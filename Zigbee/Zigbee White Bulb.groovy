...
metadata {
    definition (name: "ZigBee White Color Temperature Bulb", namespace: "castlecole", author: "SmartThings", runLocally: true, minHubCoreVersion: '000.019.00012', executeCommandsLocally: true) {
